...
# parser.add_argument('-s', '--sources', default=['jhu', 'canada', 'brazil', 'owid_tests', 'jhu_us_states_tests', 'owid_global_vaccines', 'owid_us_vaccines'],
parser.add_argument('-s', '--sources', default=['owid_us_vaccines'],
